...
The *ma'amar* begins by quoting a passuk from the *Torah* (1) which declares that there would be two portions of *man* alloted on the sixth day of the week, and none on *Shabbat*. The *ma'amar* quotes as well the *Midrash Tehillim* (2) which quotes *Rabi Yitzhak* as saying on the question of 'Why does it say 'See/Observe' [in the above passuk], "All matters of the *Shabbat* are double. The *Omer* is double (*Sheni HaOmer* is double). The *korban* is double. Its warnings (*azharot*) are double. As it states 'On the *Shabbat* there are two sheep [offered]'." As well the *ma'amar* quotes the *Rabot* which equates the *Shabbat* with all of the other *mitzvot*.
{ .annotate }
